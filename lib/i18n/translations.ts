...
export const translations: Record<Language, Translations> = {
  zh: {
    ...
    feedback: {
      ...
      correctionFallbackExplanation: "该片段与校正版存在修改，已在考生原文中标记。",
  ...
  en: {
    ...
    feedback: {
      ...
      correctionFallbackExplanation: "This excerpt differs from the corrected essay and has been marked in the original.",
